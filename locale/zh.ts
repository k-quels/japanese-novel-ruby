export default {
	settings_ruby_size_invalid: "请输入非零数值",
	
	command_insert_novel_ruby: "插入注音",
	command_insert_novel_ruby_direct : "直接插入注音符号",
	command_toggle_ruby_hidden : "切换“只在悬停时显示注音”设置",
	command_toggle_source_mode_render: "切换“在源码模式下显示注音”设置",
	...
	settings_start_character_ruby_desc: "用来替换默认的 《 符号 *现有符号不会被自动替换。",
	settings_end_character_ruby_name: "注音结束符号",
	settings_end_character_ruby_desc: "用来替换默认的 》 符号 *现有符号不会被自动替换。",
